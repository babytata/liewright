...
<head>
    ...
    <title>Soundulator - Liewright</title>
    <style>
        body {
...
<body>
    ...
    <img src="images/Aboriginal_holding_Soundulator.jpg" alt="Soundulator app" style="width: 100%; display: block;">
    <div class="container">
          <section class="app-section">
    <p><strong>Soundulator</strong> is not your ordinary calculator. It’s an interactive sound-based calculator app designed for iOS that lets you hear every number you tap. From the first digit to the final result, Soundulator plays a unique sound for each number and can replay your full calculation as a sequence of sounds.</p>

    <p>It’s part calculator, part instrument, part experience. Whether you're learning numbers, vibing with beats, or just doing math with more soul, Soundulator brings sound into the mix in a fresh, creative way.</p>

    <p>Built for thinkers, dreamers, creators—and anyone who likes their math with a little more rhythm.</p>

    <p><strong>Features:</strong></p>
    <ul>
      <li>Tap-to-hear number tones</li>
      <li>Play back full totals in sound</li>
      <li>Sleek and minimal interface</li>
      <li>Great for accessibility, music lovers, or just fun</li>
    </ul>
    ...
    <footer>
        ...
        <div class="sitemap">
            ...
            <div class="sitemap-col">
                ...
                <a href="soundulator-privacy-policy.php">Soundulator Privacy Policy</a>
            </div>
        </div>
        <div class="copyright">
