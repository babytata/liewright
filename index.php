...
<head>
    ...
    <title>Welcome to Liewright</title>
    <style>
        body {
...
<body>
    ...
    <div class="container">
        <section>
            <p>
                <span class="highlight">liewright</span> is a creative studio born... Our work is raw, unapologetic, and deeply rooted in real-life experience.
            </p>
            <p>
                From urban-inspired apparel to fine art, we're not just making products; we're building a body of work that tells a story of perseverance.
            </p>
            <p>
                Alongside our creative work, we provide other hands-on services, reflecting our core philosophy of craftsmanship in all forms.
            </p>
            <p><strong>Welcome to Liewright. Where grit meets design.</strong></p>
        </section>
    </div>
